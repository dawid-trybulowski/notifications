 ...
 */
class EmailHydrator implements EmailHydratorInterface
{
    /**
     * @param array $array
     * @return EmailEntity
    ...
    public function hydrate(array $array)
    {
        ...
        $entity->setTemplate(isset($array[EmailConstant::EMAIL_TEMPLATE]) ? new ClearString($array[EmailConstant::EMAIL_TEMPLATE]) : new ClearString(''));
